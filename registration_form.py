...
#
label_gender = tk.Label(root, text="ocupation:")
label_gender.grid(row=3, column=0, padx=10, pady=5) 

gender_var = tk.StringVar(value="student")
gender_male = tk.Radiobutton(root, text="student", variable=gender_var, value="Male")
gender_male.grid(row=3, column=1, padx=10, pady=5, sticky="w")

gender_female = tk.Radiobutton(root, text="Female", variable=gender_var, value="Female")
gender_female.grid(row=3, column=1, padx=70, pady=5, sticky="w")
#
